...
export default function UpholsteriesColor() {
  ...
  const [upholsteriesColor, setUpholsteriesColor] = useState([
    {id: uuid.v4(), img: upholsteryBlack, name: 'upholsteriesBlack', price: 300},
    {id: uuid.v4(), img: upholsteryGreen, name: 'upholsteriesGreen', price: 300},
    {id: uuid.v4(), img: upholsteryRed, name: 'upholsteriesRed', price: 300}
])
    
  return (
      <Step items={upholsteriesColor} category='upholsteries' />
  )
}
